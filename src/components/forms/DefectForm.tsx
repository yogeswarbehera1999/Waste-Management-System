...
const DefectForm: React.FC<DefectFormProps> = ({ onClose, onSubmit }) => {
  ...
  const handlePhotoCapture = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onload = (event) => {
        ...
        setFormData({ ...formData, defectImage: base64String });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      alert(error.response?.data?.message || 'Error submitting defect report');
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className="bg-white rounded-xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-green-100">
          <h2 className="text-xl font-semibold text-green-800">Machine Defect Report</h2>
          <button
            onClick={onClose}
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      setFormData({ ...formData, defectImage: '' });
                    }}
